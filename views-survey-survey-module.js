...
module.exports = "<form [formGroup]=\"interactionForm\" (ngSubmit)=\"doBulkUpload()\">\r\n  <mat-card class=\"p-1\" [@animate]=\"{ value: '*', params: { y: '50px', delay: '300ms' } }\">\r\n    <mat-card-title class=\"p-0\">\r\n      <div class=\"card-title-text\">Authenticate Demo</div>\r\n      <mat-divider></mat-divider>\r\n    </mat-card-title>\r\n    <mat-card-content class=\"p-0\">\r\n      <div class=\"text-muted mb-1 m-1 text-left\">\r\n        You can make mock product authenticate request from front-end with\r\n        adjusting configurations.\r\n      </div>\r\n    </mat-card-content>\r\n\r\n    <div fxLayout=\"row\" fxLayout.lt-sm=\"column\" fxLayoutWrap=\"wrap\">\r\n      <div fxFlex=\"50\" class=\"pr-1\">\r\n        <mat-form-field class=\"full-width\">\r\n          <mat-select [formControl]=\"interactionForm.controls['productId']\" placeholder=\"Select A Product\">\r\n            <mat-option>none</mat-option>\r\n            <mat-option (click)=\"setProductDetails(product)\" *ngFor=\"let product of products\" [value]=\"product.id\">\r\n              {{ product.name }}</mat-option>\r\n          </mat-select>\r\n        </mat-form-field>\r\n      </div>\r\n\r\n      <div fxFlex=\"50\" class=\"pr-1\">\r\n        <mat-form-field class=\"full-width\">\r\n          <input [readOnly] matInput [formControl]=\"interactionForm.controls['currentQty']\" required name=\"currentQty\"\r\n            placeholder=\"Proudct Quantity\" />\r\n        </mat-form-field>\r\n      </div>\r\n\r\n      <div fxFlex=\"50\" class=\"pr-1\">\r\n        <mat-form-field class=\"full-width\">\r\n          <input type=\"number\" matInput [formControl]=\"interactionForm.controls['qty']\" required name=\"qty\"\r\n            placeholder=\"Request Quantity\" />\r\n        </mat-form-field>\r\n      </div>\r\n    </div>\r\n\r\n    <button mat-raised-button color=\"accent\" [disabled]=\"interactionForm.invalid\">\r\n      Launch\r\n    </button>\r\n  </mat-card>\r\n</form>\r\n\r\n<form [formGroup]=\"feedbackForm\" (ngSubmit)=\"doFeedBackRequest()\">\r\n\r\n  <mat-card *ngIf=\"productDetails\" class=\"p-1\" [@animate]=\"{ value: '*', params: { y: '50px', delay: '300ms' } }\">\r\n    <mat-card-title class=\"p-0\">\r\n      <div class=\"card-title-text\">Feedback Demo {{detailLength}}</div>\r\n      <mat-divider></mat-divider>\r\n    </mat-card-title>\r\n    <mat-card-content class=\"p-0\">\r\n      <div class=\"text-muted mb-1 m-1 text-left\">\r\n        You can make mock product feedback request adjusting configurations.\r\n      </div>\r\n    </mat-card-content>\r\n\r\n    <div fxLayout=\"row\" fxLayout.lt-sm=\"column\" fxLayoutWrap=\"wrap\">\r\n      <div fxFlex=\"50\" class=\"pr-1\">\r\n        <mat-form-field class=\"full-width\">\r\n          <mat-select [formControl]=\"feedbackForm.controls['surveyId']\" placeholder=\"Select A Feedback\">\r\n            <mat-option>none</mat-option>\r\n            <mat-option (click)=\"showSurveyInfo(survey)\" *ngFor=\"let survey of surveyRows\" [value]=\"survey.id\">\r\n              {{ survey.topic }}</mat-option>\r\n          </mat-select>\r\n        </mat-form-field>\r\n      </div>\r\n      <div fxFlex=\"50\" class=\"pr-1\">\r\n        <mat-form-field class=\"full-width\">\r\n          <input type=\"number\" matInput [formControl]=\"feedbackForm.controls['qty']\" required name=\"qty\"\r\n            placeholder=\"Request Quantity\" />\r\n        </mat-form-field>\r\n      </div>\r\n\r\n      <!--\r\n        <div  *ngIf=\"surveyRecord\" fxFlex=\"50\" class=\"pr-1\">{{ surveyRecord.topic }}</div>\r\n      -->\r\n      <mat-card *ngIf=\"surveyRecord\" class=\"p-1\" [@animate]=\"{ value: '*', params: { y: '50px', delay: '300ms' } }\">\r\n        {{ surveyRecord.topic }}\r\n\r\n        <div *ngFor=\"let question of surveyRecord.questions; let i = index\" fxLayout=\"row\" fxLayout.lt-sm=\"column\"\r\n          fxLayoutWrap=\"wrap\">\r\n          <span href=\"#\" class=\"timeline-body-title mr-1\"><b>Question {{ i + 1 }}</b></span>\r\n          <span class=\"text-muted\">{{ question.name }}</span><br />\r\n\r\n          <div *ngIf=\"question.answerTemplate\">\r\n            <div class=\"p-1\" class=\"timeline-body-top\">\r\n              <span class=\"text-muted\">{{ question.answerTemplate.name }}<br /></span>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </mat-card>\r\n    </div>\r\n\r\n    <button mat-raised-button color=\"accent\" [disabled]=\"feedbackForm.invalid\">\r\n      Launch\r\n    </button>\r\n  </mat-card>\r\n</form>"
