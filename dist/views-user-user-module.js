(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ...
  \*********************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _client_client_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../../client/client.service */ "./src/app/views/client/client.service.ts"
        );
        /* harmony import */ var app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! app/model/ClientModel.model */ "./src/app/model/ClientModel.model.ts"
        );
        var __decorate =
        ...
        var RoleTablePopupComponent = /** @class */ (function() {
          ...
          RoleTablePopupComponent.prototype.ngOnInit = function() {
            ...
            if (this.isNew) {
              this.createUserAuthorityComponentList(
                this.data.adminRoleAuthorities
              );
            } else {
          ...
          RoleTablePopupComponent.prototype.formatRoleAuthority = function(
            data
          ) {
            var _this = this;
          ...
          RoleTablePopupComponent.prototype.createUserAuthorityComponentList = function(
            data
          ) {
            var _this = this;
            var roleData = JSON.parse(JSON.stringify(data));
            var displayAuthoritySection = {
          ...
          RoleTablePopupComponent.prototype.submit = function() {
            ...
            this.selectedAuthorities.forEach(function(authorityID) {
              authorities.push(
                new app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_4__[
                  "AuthorityData"
                ](authorityID)
              );
            });
            ...
            if (this.isNew) {
              roleData = {
                ...
                client: new app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_4__[
                  "ClientData"
                ](this.clientID)
              };
            } else {
          ...
          RoleTablePopupComponent.prototype.onChangeUserRole = function(
            authority,
            isChecked
          ) {
            ...
            if (isChecked) {
              ...
              var index = dataArray.controls.findIndex(function(x) {
                return x.value === authority.code;
              });
              dataArray.removeAt(index);
              var i = this.selectedAuthorities.findIndex(function(y) {
                return y === authority.id;
              });
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
                ...
                template: __webpack_require__(
                  /*! ./role-table-popup.component.html */ "./src/app/views/user/roles/role-table-popup/role-table-popup.component.html"
                )
              }),
              __param(
                0,
              ...
              __metadata("design:paramtypes", [
                ...
                _client_client_service__WEBPACK_IMPORTED_MODULE_3__[
                  "ClientService"
                ]
              ])
            ],
  ...
  \**********************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _client_client_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../../client/client.service */ "./src/app/views/client/client.service.ts"
        );
        /* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js"
        );
        /* harmony import */ var _shared_services_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../../shared/services/app-confirm/app-confirm.service */ "./src/app/shared/services/app-confirm/app-confirm.service.ts"
        );
        /* harmony import */ var _shared_services_app_loader_app_loader_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../../shared/services/app-loader/app-loader.service */ "./src/app/shared/services/app-loader/app-loader.service.ts"
        );
        /* harmony import */ var _role_table_popup_role_table_popup_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./role-table-popup/role-table-popup.component */ "./src/app/views/user/roles/role-table-popup/role-table-popup.component.ts"
        );
        /* harmony import */ var _shared_animations_egret_animations__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../../../shared/animations/egret-animations */ "./src/app/shared/animations/egret-animations.ts"
        );
        /* harmony import */ var _shared_services_app_error_app_error_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ../../../shared/services/app-error/app-error.service */ "./src/app/shared/services/app-error/app-error.service.ts"
        );
        /* harmony import */ var app_views_sessions_authentication_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! app/views/sessions/authentication.service */ "./src/app/views/sessions/authentication.service.ts"
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function(decorators, target, key, desc) {
        ...
        var RoleTableComponent = /** @class */ (function() {
          ...
          RoleTableComponent.prototype.openPopUp = function(roleData, isNew) {
            ...
            this.clientService
              .getAdminAuthority(this.adminRoleId)
              .subscribe(function(response) {
                ...
                var dialogRef = _this.dialog.open(
                  _role_table_popup_role_table_popup_component__WEBPACK_IMPORTED_MODULE_5__[
                    "RoleTablePopupComponent"
                  ],
                  {
                    width: "900px",
                ...
                dialogRef.afterClosed().subscribe(function(res) {
                  ...
                  if (isNew) {
                    ...
                    console.log(res);
                    _this.clientService.createNewRole(res).subscribe(
                      function(response) {
                    ...
                    console.log(
                      "------------ update user role object ---------------"
                    );
                    console.log(res);
                    _this.clientService
                      .updateRloe(_this.editRoleId, res)
                      .subscribe(
                        function(response) {
                          // console.log('--------------- create user role response ----------------');
                          // console.log(response);
          ...
          RoleTableComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
                ...
                template: __webpack_require__(
                  /*! ./role-table.component.html */ "./src/app/views/user/roles/role-table.component.html"
                ),
                animations:
                  _shared_animations_egret_animations__WEBPACK_IMPORTED_MODULE_6__[
                    "egretAnimations"
                  ]
              }),
              __metadata("design:paramtypes", [
                ...
                _client_client_service__WEBPACK_IMPORTED_MODULE_1__[
                  "ClientService"
                ],
                _shared_services_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_3__[
                  "AppConfirmService"
                ],
                _shared_services_app_loader_app_loader_service__WEBPACK_IMPORTED_MODULE_4__[
                  "AppLoaderService"
                ],
                _shared_services_app_error_app_error_service__WEBPACK_IMPORTED_MODULE_7__[
                  "AppErrorService"
                ],
                app_views_sessions_authentication_service__WEBPACK_IMPORTED_MODULE_8__[
  ...
  \********************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! @angular/cdk/keycodes */ "./node_modules/@angular/cdk/esm5/keycodes.es5.js"
        );
        ...
        var UserCategoryPopupComponent = /** @class */ (function() {
          function UserCategoryPopupComponent(data, dialogRef, fb) {
            ...
            this.categoryCtrl = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
              "FormControl"
            ]();
            this.allCategories = [];
            ...
            this.filteredCategories = this.categoryCtrl.valueChanges.pipe(
              ...
              Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(
                function(category) {
                  return category
                    ? _this._filterCategories(category)
                    : _this.allCategories.slice();
                }
              )
            );
          }
          ...
          UserCategoryPopupComponent.prototype.addSelectedCategory = function(
            id
          ) {
            var _this = this;
          ...
          UserCategoryPopupComponent.prototype._filterCategories = function(
            value
          ) {
          ...
          __decorate(
            ...
            UserCategoryPopupComponent.prototype,
            "categoryInput",
            void 0
          );
          __decorate(
          ...
          UserCategoryPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
                ...
                template: __webpack_require__(
                  /*! ./user-category-popup.component.html */ "./src/app/views/user/user-table/user-category-popup/user-category-popup.component.html"
                )
              }),
              __param(
                0,
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var UserCommunityPopupComponent = /** @class */ (function() {
          ...
          UserCommunityPopupComponent.prototype.ngOnInit = function() {
            var _this = this;
            this.allCommunities = JSON.parse(
              JSON.stringify(this.data.community)
            );
          ...
          UserCommunityPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
                ...
                template: __webpack_require__(
                  /*! ./user-community-popup.component.html */ "./src/app/views/user/user-table/user-community-popup/user-community-popup.component.html"
                )
              }),
              __param(
                0,
  ...
  \****************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_animations_egret_animations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../../../shared/animations/egret-animations */ "./src/app/shared/animations/egret-animations.ts"
        );
        /* harmony import */ var _shared_helpers_global_variable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../../../shared/helpers/global-variable */ "./src/app/shared/helpers/global-variable.ts"
        );
        /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js"
        );
        /* harmony import */ var _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! @angular/cdk/keycodes */ "./node_modules/@angular/cdk/esm5/keycodes.es5.js"
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
        ...
        var UserCreatePopupComponent = /** @class */ (function() {
          function UserCreatePopupComponent(data, dialogRef, fb, snackBar) {
            ...
            this.globalVariable = new _shared_helpers_global_variable__WEBPACK_IMPORTED_MODULE_4__[
              "GlobalVariable"
            ]();
            ...
            this.addOnBlur = true;
            this.separatorKeysCodes = [
              _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_6__["ENTER"],
              _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_6__["COMMA"]
            ];
            this.categoryCtrl = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
              "FormControl"
            ]();
            ...
            this.selectedCommunities = [];
            this.filteredCategories = this.categoryCtrl.valueChanges.pipe(
              Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(
                null
              ),
          ...
          UserCreatePopupComponent.prototype.buildItemForm = function() {
            ...
            // });
            this.userFormGroup = this.fb.group({
              username: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
                "FormControl"
              ](
                "",
              ...
              password: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
                "FormControl"
              ](
                "",
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
              ...
              email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
                "FormControl"
              ]("", [
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"]
                  .required,
              ...
              role: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
                "FormControl"
              ](
                "",
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
          ...
          UserCreatePopupComponent.prototype.addSelectedCategory = function(
            id
          ) {
            var _this = this;
            this.allCategories.forEach(function(item, index) {
          ...
          UserCreatePopupComponent.prototype._filterCategories = function(
            value
          ) {
            var filterValue = value.toLowerCase();
            return this.allCategories.filter(function(category) {
          ...
          __decorate(
            ...
            UserCreatePopupComponent.prototype,
            "categoryInput",
            void 0
          );
          __decorate(
          ...
          UserCreatePopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
                ...
                template: __webpack_require__(
                  /*! ./user-create-popup.component.html */ "./src/app/views/user/user-table/user-create-popup/user-create-popup.component.html"
                ),
                animations:
                  _shared_animations_egret_animations__WEBPACK_IMPORTED_MODULE_3__[
                    "egretAnimations"
                  ]
              }),
              __param(
          ...
          UserTablePopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
                ...
                template: __webpack_require__(
                  /*! ./user-table-popup.component.html */ "./src/app/views/user/user-table/user-table-popup/user-table-popup.component.html"
                )
              }),
              __param(
                0,
  ...
  \***************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_services_app_loader_app_loader_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../../shared/services/app-loader/app-loader.service */ "./src/app/shared/services/app-loader/app-loader.service.ts"
        );
        /* harmony import */ var _user_table_user_create_popup_user_create_popup_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../user-table/user-create-popup/user-create-popup.component */ "./src/app/views/user/user-table/user-create-popup/user-create-popup.component.ts"
        );
        /* harmony import */ var _user_table_user_table_popup_user_table_popup_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ../user-table/user-table-popup/user-table-popup.component */ "./src/app/views/user/user-table/user-table-popup/user-table-popup.component.ts"
        );
        /* harmony import */ var _shared_animations_egret_animations__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../../../shared/animations/egret-animations */ "./src/app/shared/animations/egret-animations.ts"
        );
        ...
        /* harmony import */ var app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! app/model/ClientModel.model */ "./src/app/model/ClientModel.model.ts"
        );
        /* harmony import */ var _user_category_popup_user_category_popup_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./user-category-popup/user-category-popup.component */ "./src/app/views/user/user-table/user-category-popup/user-category-popup.component.ts"
        );
        /* harmony import */ var _user_community_popup_user_community_popup_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ./user-community-popup/user-community-popup.component */ "./src/app/views/user/user-table/user-community-popup/user-community-popup.component.ts"
        );
        /* harmony import */ var app_views_sessions_authentication_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! app/views/sessions/authentication.service */ "./src/app/views/sessions/authentication.service.ts"
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
        ...
        var UserTableComponent = /** @class */ (function() {
          ...
          UserTableComponent.prototype.getClientAndUserCommunities = function(
            popup,
            user
          ) {
            var _this = this;
              ...
              .subscribe(
                function(successResp) {
                  ...
                  if (popup === "UserCreatePopup") {
                    ...
                    _this.clientService.getUser(user.id).subscribe(
                      function(successResp) {
                        var userCommunity = successResp.content.communities;
                        _this.communityPopup(
                          user.id,
                          clientCommunity,
                          userCommunity
                        );
          ...
          UserTableComponent.prototype.userCreatePopup = function(
            ...
            var dialogRef = this.dialog.open(
              _user_table_user_create_popup_user_create_popup_component__WEBPACK_IMPORTED_MODULE_4__[
                "UserCreatePopupComponent"
              ],
              {
                width: "720px",
            ...
            dialogRef.afterClosed().subscribe(function(res) {
              ...
              _this.loader.open();
              var role = new app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_9__[
                "RoleData"
              ](res[0].role);
              var communities = [];
              res[2].forEach(function(element) {
                communities.push(
                  new app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_9__[
                    "CommunityData"
                  ](element.id)
                );
              });
              ...
              var client = new app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_9__[
                "ClientData"
              ](_this.clientId);
              var req = new app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_9__[
                "UserCreateReq"
              ](
                res[0].username,
                res[0].password,
              ...
              _this.clientService.addUser(req).subscribe(
                function(response) {
                  _this.getUsersByClient();
                  _this.loader.close();
                  _this.snack.open("New User added !", "OK", {
                    duration: 4000
                  });
                },
                function(error) {
          ...
          UserTableComponent.prototype.openEditPopUp = function(data) {
            ...
            var dialogRef = this.dialog.open(
              _user_table_user_table_popup_user_table_popup_component__WEBPACK_IMPORTED_MODULE_5__[
                "UserTablePopupComponent"
              ],
              {
                width: "720px",
            ...
            dialogRef.afterClosed().subscribe(function(res) {
              ...
              var req = new app_model_ClientModel_model__WEBPACK_IMPORTED_MODULE_9__[
                "UserUpdateReq"
              ](res.username, res.email, role);
              _this.loader.open();
              _this.clientService.updateUser(data.id, req).subscribe(
                function(response) {
                  _this.getUsersByClient();
                  _this.loader.close();
          ...
          UserTableComponent.prototype.communityPopup = function(
            userId,
            clientCommunities,
            userCommunities
          ) {
            var _this = this;
            var dialogRef = this.dialog.open(
              _user_community_popup_user_community_popup_component__WEBPACK_IMPORTED_MODULE_11__[
                "UserCommunityPopupComponent"
              ],
              {
                width: "720px",
                disableClose: true,
                data: {
                  community: clientCommunities,
                  selectedCommunity: userCommunities
                }
              }
            );
            dialogRef.afterClosed().subscribe(function(res) {
              ...
              _this.loader.open();
              _this.clientService.updateUserCommunity(userId, req).subscribe(
                function(response) {
                  _this.getUsersByClient();
                  _this.loader.close();
                  _this.snack.open("User Community Updated!", "OK", {
                    duration: 4000
                  });
                },
                function(error) {
          ...
          UserTableComponent.prototype.openCategoryPopUp = function(data) {
            ...
            this.getItemSub = this.clientService.getUser(data.id).subscribe(
              function(successResp) {
                ...
                var dialogRef = _this.dialog.open(
                  _user_category_popup_user_category_popup_component__WEBPACK_IMPORTED_MODULE_10__[
                    "UserCategoryPopupComponent"
                  ],
                  {
                    width: "720px",
                ...
                dialogRef.afterClosed().subscribe(function(res) {
                  ...
                  _this.loader.open();
                  _this.clientService
                    .updateUserCategories(data.id, req)
                    .subscribe(
                      function(response) {
                        _this.loader.close();
                        _this.snack.open("User Category Updated!", "OK", {
                          duration: 4000
                        });
                      },
                      function(error) {
          ...
          UserTableComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
                ...
                template: __webpack_require__(
                  /*! ./user-table.component.html */ "./src/app/views/user/user-table/user-table.component.html"
                ),
                animations:
                  _shared_animations_egret_animations__WEBPACK_IMPORTED_MODULE_6__[
                    "egretAnimations"
              ...
              __metadata("design:paramtypes", [
                ...
                _shared_services_app_loader_app_loader_service__WEBPACK_IMPORTED_MODULE_3__[
                  "AppLoaderService"
                ],
                _shared_services_app_error_app_error_service__WEBPACK_IMPORTED_MODULE_7__[
                  "AppErrorService"
                ...
                app_views_sessions_authentication_service__WEBPACK_IMPORTED_MODULE_12__[
                  "AuthenticationService"
                ]
              ])
            ],
  ...
  \**********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_animations_egret_animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../../shared/animations/egret-animations */ "./src/app/shared/animations/egret-animations.ts"
        );
        /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js"
        );
        /* harmony import */ var _sessions_authentication_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../sessions/authentication.service */ "./src/app/views/sessions/authentication.service.ts"
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function(decorators, target, key, desc) {
          ...
          UserComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
                selector: "app-user",
                template: __webpack_require__(
                  /*! ./user.component.html */ "./src/app/views/user/user.component.html"
                ),
                animations:
                  _shared_animations_egret_animations__WEBPACK_IMPORTED_MODULE_1__[
                    "egretAnimations"
                  ]
              }),
              __metadata("design:paramtypes", [
                ...
                _sessions_authentication_service__WEBPACK_IMPORTED_MODULE_3__[
                  "AuthenticationService"
                ]
              ])
            ],
  ...
  \*******************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js"
        );
        ...
        /* harmony import */ var _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! @swimlane/ngx-datatable */ "./node_modules/@swimlane/ngx-datatable/release/index.js"
        );
        /* harmony import */ var _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/ __webpack_require__.n(
          _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_6__
        );
        /* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ../../shared/shared.module */ "./src/app/shared/shared.module.ts"
        );
        /* harmony import */ var _user_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ./user.component */ "./src/app/views/user/user.component.ts"
        );
        /* harmony import */ var _user_table_user_table_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ./user-table/user-table.component */ "./src/app/views/user/user-table/user-table.component.ts"
        );
        /* harmony import */ var _user_table_user_create_popup_user_create_popup_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./user-table/user-create-popup/user-create-popup.component */ "./src/app/views/user/user-table/user-create-popup/user-create-popup.component.ts"
        );
        /* harmony import */ var _user_table_user_category_popup_user_category_popup_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ./user-table/user-category-popup/user-category-popup.component */ "./src/app/views/user/user-table/user-category-popup/user-category-popup.component.ts"
        );
        /* harmony import */ var _user_table_user_community_popup_user_community_popup_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ./user-table/user-community-popup/user-community-popup.component */ "./src/app/views/user/user-table/user-community-popup/user-community-popup.component.ts"
        );
        /* harmony import */ var _roles_role_table_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ./roles/role-table.component */ "./src/app/views/user/roles/role-table.component.ts"
        );
        /* harmony import */ var _roles_role_table_popup_role_table_popup_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ./roles/role-table-popup/role-table-popup.component */ "./src/app/views/user/roles/role-table-popup/role-table-popup.component.ts"
        );
        /* harmony import */ var _client_client_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ../client/client.service */ "./src/app/views/client/client.service.ts"
        );
        /* harmony import */ var _user_routing__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ./user.routing */ "./src/app/views/user/user.routing.ts"
        );
        /* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ./user.service */ "./src/app/views/user/user.service.ts"
        );
        /* harmony import */ var _user_table_user_table_popup_user_table_popup_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ./user-table/user-table-popup/user-table-popup.component */ "./src/app/views/user/user-table/user-table-popup/user-table-popup.component.ts"
        );
        /* harmony import */ var ngx_intl_tel_input__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
          /*! ngx-intl-tel-input */ "./node_modules/ngx-intl-tel-input/fesm5/ngx-intl-tel-input.js"
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function(decorators, target, key, desc) {
              ...
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
                imports: [
                  ...
                  _angular_router__WEBPACK_IMPORTED_MODULE_2__[
                    ...
                    _user_routing__WEBPACK_IMPORTED_MODULE_16__["UserRoutes"]
                  ),
                  _angular_material__WEBPACK_IMPORTED_MODULE_4__[
                    "MatSlideToggleModule"
                  ],
                  ...
                  ngx_intl_tel_input__WEBPACK_IMPORTED_MODULE_19__[
                ...
                declarations: [
                  ...
                  _user_table_user_table_component__WEBPACK_IMPORTED_MODULE_9__[
                    "UserTableComponent"
                  ],
                  _user_table_user_table_popup_user_table_popup_component__WEBPACK_IMPORTED_MODULE_18__[
                    "UserTablePopupComponent"
                  ],
                  _user_table_user_create_popup_user_create_popup_component__WEBPACK_IMPORTED_MODULE_10__[
                    "UserCreatePopupComponent"
                  ],
                  _user_table_user_community_popup_user_community_popup_component__WEBPACK_IMPORTED_MODULE_12__[
                    "UserCommunityPopupComponent"
                  ],
                  _user_table_user_category_popup_user_category_popup_component__WEBPACK_IMPORTED_MODULE_11__[
                    "UserCategoryPopupComponent"
                  ],
                  _roles_role_table_component__WEBPACK_IMPORTED_MODULE_13__[
                    "RoleTableComponent"
                  ],
                  _roles_role_table_popup_role_table_popup_component__WEBPACK_IMPORTED_MODULE_14__[
                    "RoleTablePopupComponent"
                  ]
                ],
                providers: [
                  _user_service__WEBPACK_IMPORTED_MODULE_17__["UserService"],
                  _client_client_service__WEBPACK_IMPORTED_MODULE_15__[
                    "ClientService"
                  ]
                ],
                entryComponents: [
  ...
  \********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _user_table_user_table_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./user-table/user-table.component */ "./src/app/views/user/user-table/user-table.component.ts"
        );
        /* harmony import */ var _roles_role_table_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./roles/role-table.component */ "./src/app/views/user/roles/role-table.component.ts"
        );
            ...
            children: [
              {
                path: "user-table",
                component:
                  _user_table_user_table_component__WEBPACK_IMPORTED_MODULE_0__[
                    "UserTableComponent"
                  ],
              ...
              },
              {
                path: "role-table",
                component:
                  _roles_role_table_component__WEBPACK_IMPORTED_MODULE_1__[
                    "RoleTableComponent"
                  ],
