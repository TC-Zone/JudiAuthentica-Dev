...
/* harmony import */ var app_shared_helpers_global_variable__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! app/shared/helpers/global-variable */ "./src/app/shared/helpers/global-variable.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CommunityViewComponent = /** @class */ (function () {
    function CommunityViewComponent(dialog, snack, router, confirmService, loader, errDialog, communityService, appWarningService, appInfoService, authService) {
        ...
        this.statusArray = new app_shared_helpers_global_variable__WEBPACK_IMPORTED_MODULE_14__["GlobalVariable"]().common.matChip.colorForStatus01;
        this.quota = 0;
...
var CreateEventPopupComponent = /** @class */ (function () {
            ...
            reader.onload = function (event) {
                ...
                img.onload = function () {
                    if (img.width < _this.minWidth || img.height < _this.minHeight) {
                        ...
                        _this.eventImgsElemnt.nativeElement.value = "";
                        // this.eventForm.controls['poster'].setErrors({ 'incorrect': true });
                        return;
                    }
                };
    ...
    */
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('eventImgs'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], CreateEventPopupComponent.prototype, "eventImgsElemnt", void 0);
    ...
    UserFeedbackComponent.prototype.feedbackPopUp = function (data, isNew) {
        ...
        this.communityService.licenseExpireState(this.clientId, "feedbacks").subscribe(function (response) {
            ...
            if (_this.quotaExpire && isNew) {
                ...
                var title = isNew ? "Submit your feedback" : "Update Feedback";
...
var CreatePromotionPopupComponent = /** @class */ (function () {
    ...
    */
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('promotionImgs'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], CreatePromotionPopupComponent.prototype, "eventImgsElemnt", void 0);
